...
namespace Sammlung.CommandLine.Terminal
{
    internal static class TerminalExtensions
    {
        ...
        public static void Write(this IOutputWriter writer, IEnumerable<string> values) => writer.Write(string.Join(" ", values));
        ...
        public static void WriteLine(this IOutputWriter writer, IEnumerable<string> values) => writer.WriteLine(string.Join(" ", values));
    }
}